...
public class UcMongoDbDataSource implements DataSource, UcJdbcWrapper, Closeable {

    private PrintWriter writer;
    private int loginTimeout;
    private Properties props;
    private MongoDbOper mongoDbOper = new MongoDbOper();
    ...
    public synchronized void init(Properties properties) throws UnknownHostException, SQLException, URISyntaxException {
        props = properties;
        ucPoolConnection.init(properties,mongoDbOper);
    }
