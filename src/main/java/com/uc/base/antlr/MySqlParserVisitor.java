...
public interface MySqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MySqlParser#highlightTypeClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHighlightTypeClause(MySqlParser.HighlightTypeClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#highlightColumnClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHighlightColumnClause(MySqlParser.HighlightColumnClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#highlightColumnExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHighlightColumnExpression(MySqlParser.HighlightColumnExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#highlightTagClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHighlightTagClause(MySqlParser.HighlightTagClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#highlightClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHighlightClause(MySqlParser.HighlightClauseContext ctx);
	/**
	 * Visit a parse tree produced by {@link MySqlParser#deepScanClause}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeepScanClause(MySqlParser.DeepScanClauseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code bracketPredicate}
	 * labeled alternative in {@link MySqlParser#predicate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBracketPredicate(MySqlParser.BracketPredicateContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code statementParamPredicate}
	 * labeled alternative in {@link MySqlParser#predicate}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatementParamPredicate(MySqlParser.StatementParamPredicateContext ctx);
	/**
